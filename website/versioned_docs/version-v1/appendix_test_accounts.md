---
id: appendix_test_accounts
title: Testing on Ropsten (Ethereum Testnet)
...
For testing purposes, you may download the Chrome Extension [Metamask](https://metamask.io/) to manage your wallet to [deploy new certificate store](./deploying_store) and [issue a batch of certificates](./issuing_certificates).
