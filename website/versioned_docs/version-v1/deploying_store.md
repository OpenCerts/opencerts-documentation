---
id: deploying_store
title: Deploying Certificate Store
sidebar_label: Deploying Certificate Store
---
...
The admin interface supports the ropsten network for development and testing. Visit [Appendix A: Getting Testnet Account & Ethers](./appendix_test_accounts) to get a funded Ethereum wallet to follow the instructions below.
