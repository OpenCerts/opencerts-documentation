---
id: custom_template
title: Custom Templates for Certificates
...
Details on the integration test can be found in the [next chapter](./integration_test).

## Submitting your changes

Once you have added the template for your certificates, check your code against our [pull request checklist](./appendix_pull_request_checklist).
...
OpenCerts allow users to obfuscate values in the document. The API to enable data obfuscation on your custom template can be found [in the appendix](./appendix_data_obfuscation).
