---
id: issuing_multisig_certificate
title: Issue Certificates using MultiSig Wallet
sidebar_label: MultiSig Issuance
---
...
12. Now go to [https://admin.opencerts.io](https://admin.opencerts.io) and deploy the new instance of the store using your Ledger Nano S (follow these instructions [Deploying Store](./deploying_store)).
