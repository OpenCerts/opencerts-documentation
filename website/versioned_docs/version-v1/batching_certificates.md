---
id: batching_certificates
title: Batching Certificates
sidebar_label: Batching Certificates
---
...
To facilitate the ease of signing and batching OpenCerts, a [npm package](https://www.npmjs.com/package/@govtechsg/open-certificate) and a [CLI tool](https://github.com/GovTechSG/certificate-cli) is provided.
...
Note the merkle root, it will be [published onto the certficate store](./issuing_certificates) in later steps.
