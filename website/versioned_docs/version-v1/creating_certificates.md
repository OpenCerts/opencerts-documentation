---
id: creating_certificates
title: Creating Certificates
sidebar_label: Creating Certificates
---
...
The `certificateStore` address can be obtained after [deploying an instance of the smart contract](./deploying_store).
...
The `additionalData` field is an object that allows you to insert any type of data into it. These data will be present for [custom certificate templates](./custom_template).
